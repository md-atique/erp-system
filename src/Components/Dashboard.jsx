...
//           <div className="bg-white p-6 rounded-lg shadow-md flex items-center justify-between">
//           <div>
//               <h2 to="/products"className="text-xl font-semibold mb-2">Products</h2>
//               <p className="text-gray-600">Total Number of Products: <p className='text-gray-700 font-bold'>{totalProducts}</p></p>
//             </div>
//             <Link to="/products" className="text-blue-500  pb-12 hover:underline">
//               <FontAwesomeIcon icon={faBox} className="text-xl" />
//             </Link>
...
//             <div>
//               <h2 className="text-xl font-semibold mb-2">Orders</h2>
//               <p className="text-gray-600">Total Number of Orders:  <p className='text-gray-700 font-bold' >{totalOrders}</p></p>
//             </div>
//             <Link to="/orders" className="text-blue-500 pb-10 hover:underline">
//               <FontAwesomeIcon icon={faClipboardList} className="text-xl" />
//             </Link>
